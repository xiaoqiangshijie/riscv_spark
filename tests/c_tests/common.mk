...
LDFLAGS += -T ../link.lds -nostartfiles -Wl,--gc-sections -Wl,--check-sections  # -T表示自己的链接脚本


all: clean $(TARGET)

$(TARGET):
	$(RISCV_GCC) $(CFLAGS) -c ../start.S
	$(RISCV_GCC) $(CFLAGS) -c main.c
	$(RISCV_GCC) $(CFLAGS) $(LDFLAGS) start.o main.o -o $@
