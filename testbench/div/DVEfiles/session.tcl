...
# DVE reload session
# Saved on Thu May 13 16:37:19 2021
# Designs open: 1
...
gui_open_source -id ${Source.1}  -replace -active div_test /home/lj/ic/riscv_soc/testbench/div/./div_tb.v
...
gui_wv_zoom_timerange -id ${Wave.1} 430.564 838.068
gui_list_add_group -id ${Wave.1} -after {New Group} {u_div}
gui_list_select -id ${Wave.1} {div_test.u_div.div_result div_test.u_div.minuend div_test.u_div.minuend_ge_divisor div_test.u_div.minuend_sub_res div_test.u_div.div_result_tmp div_test.u_div.minuend_tmp }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group u_div  -position in

gui_marker_move -id ${Wave.1} {C1} 679.805
